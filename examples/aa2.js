...
this.aa = function () {
  ...
  var PromiseLight = require('promise-light');
  ...
  function aa(gtor) {
    ...
    var resolve, reject, p = new PromiseLight( // PtomiseThunk(
    ...
    function doValue(value, callback) {
      ...
      if (typeof value === 'function')
        ...
        //if (value instanceof GeneratorFunctionPrototype || value.next)
        //if (value.constructor === GeneratorFunctionPrototype || value.next)
        if (value.next)
          //return aa.call(ctx, value)(callback);
          return aa.call(ctx, value).then(function (val) { callback(null, val); }, callback);
